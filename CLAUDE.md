...
ამ workspace-ს იყენებენ თამარი მაისაშვილი-ციხელაშვილი და მისი შვილი ლეო იასარევიჩი — დედა-შვილის გუნდი, რომლებიც ერთობლივად და დამოუკიდებლად მუშაობენ ციფრულ პროექტებზე.

**თამარი** — ვილერბანი (ლიონი, საფრანგეთი). პროფესიონალი ფრანგულ-ქართული თარჯიმანი (სასამართლო/საიმიგრაციო სფერო), „ემიგრანტის გზამკვლევი საფრანგეთში"-ის ავტორი, ციფრული მეწარმე და კონტენტ-შემქმნელი. საფრანგეთში ცხოვრობს 1998 წლიდან.

**ლეო** — ახალგაზრდა indie developer და მეწარმე. Ritualis-ის (ჩვევების აპლიკაცია) შემქმნელი, AI/SaaS პროდუქტების მკვლევარი, ვებ და მობილური აპლიკაციების დეველოპერი.

მთავარი პრიორიტეტები ახლა: თამარისთვის — „ემიგრანტის გზამკვლევის" ვებსაიტი და Sales Funnel; ლეოსთვის — Ritualis-ის App Store/Google Play-ზე გაშვება.

გრძელვადიანი მიზანი: ძლიერი ციფრული ეკოსისტემა, TrottiLink-ის MVP, Ritualis-ის საერთაშორისო მასშტაბირება.
